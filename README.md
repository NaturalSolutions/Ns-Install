# Bievenue 🙋🏻‍♂️🙋🏻‍♀️
Ce répertoire a pour vocation de faciliter les instalations de beaucoup d'applications développées par Natural Solution.
...
# Comment ça marche 👩🏻‍🏫
## Une fichier d'instalation par application 📁
Tous ces fichiers d'installations sont des fichiers .bat et .sh.  
Ce sont des fichiers qui, une fois lancés, vont exécuter des commandes que le développeur à lui même décidé au préalable.  
Et parceque le développeur est ton ami, il a développer les étapes d'installation, une par une, en ligne de commandes dans un seul fichier.  
...
Pour que ces .bat fonctionne il va te falloir
